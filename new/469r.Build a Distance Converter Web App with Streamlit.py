'''
Project Overview 💡
    In this real-world project, you’ll build a lightweight Streamlit app that allows users to convert distances between kilometers and miles in both directions. 
    This project helps reinforce your knowledge of functions, user input handling, and interactive UI design with Streamlit.
