'''
Project Description
    Your task today is to create a command-line Python app that fetches data from a CSV file hosted online and lets the user query it by name. 
    The program should then display the corresponding age and city of that person.
...
It contains 3 columns: Name, Age, and City. 
...
Bonus: In the solution page, you will also see how to do this using both the built-in csv module and the powerful pandas library.
