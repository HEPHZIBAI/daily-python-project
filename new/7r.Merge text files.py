...
'''
with open("./new./3.Merge text files/merge.txt",'a') as f:

    with open("./new./3.Merge text files/a.txt",'r') as a:
        for i in a.readlines():
            f.write(i+"\n")

    with open("./new./3.Merge text files/b.txt",'r') as a:
        for i in a.readlines():
            f.write(i+"\n")

    with open("./new./3.Merge text files/c.txt",'r') as a:
        for i in a.readlines():
            f.write(i+"\n")