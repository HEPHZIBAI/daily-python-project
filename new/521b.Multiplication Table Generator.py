'''
Your task for today is to write a Python program that generates a multiplication table for any number entered by the user. 
This is a classic exercise that strengthens your understanding of loops, user input, and basic math operations.
