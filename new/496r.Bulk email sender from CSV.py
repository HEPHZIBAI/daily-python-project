...
Project Description
    ...
    This is incredibly useful in real life — from sending newsletters and promotional updates, to internal announcements or even school-wide messages. 
    No more copy-pasting emails manually!
...
By completing this project, you'll learn:
    ...
    how to safely use app passwords for Gmail and Outlook accounts

Sample recipients.csv File
    Create an empty file in your computer, paste the following data, and save the file under the recipients.csv name. 
    Make sure to place some real email addresses there.
