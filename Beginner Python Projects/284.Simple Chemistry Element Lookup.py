...
Expected Output
    The program asks the user to enter an element symbol (i.e., “O”). 
    Then, the program returns the information about that element (i.e., “Oxygen: Atomic Number 8”)
...
element=input("enter the chemical symbol (e.g., H, He, C): ").strip()
if element in elements:
    print(elements[element]["name"],": Atomic Number",elements[element]["atomic_number"])
else:
