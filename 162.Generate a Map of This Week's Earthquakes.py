...
How the program works
    Similar to the previous project, the program makes an API request to the United States Geological 
    Survey API at the following endpoint to get all the earthquakes that occured during the current week:

    https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson

    The program plots the earthquake locations on an interactive world map using Folium.
